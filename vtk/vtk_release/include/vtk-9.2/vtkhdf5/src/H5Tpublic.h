 ...
 * \type_id Identifier of datatype to be committed and, upon functions
 ...
 *          \li H5Tcommit_anon() neither provides the new named datatypes
 ...
 *
 *          Values returned in \p value will be of the enumerated types
 ...
 *          types base type, that is, the datatype used by H5Tenum_create()
