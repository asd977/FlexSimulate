 ...
 *          link in the files root group. For instance, if \c datasetD
 ...
 * \return \herr_t
 *
 * \details H5Oget_info_by_name3() specifies an objects location and name,
 ...
 *          index is to be traversed, \p order, and an objects position
 ...
 *
 *          An objects reference count is the number of hard links in the
 *          file that point to that object. See the Programming Model
 *          section of the HDF5 Groups chapter in the -- <em>HDF5 Users Guide</em>
 *          for a more complete discussion of reference counts.
 *
 *          If a user application needs to determine an objects reference
 ...
 *          placed in that files root group.
 *
 ...
 *          the copy will be created relative to the files root group.
 *
 ...
 *          - An absolute name of the object, starting from \c /, the files root group
 ...
 *          that files root group serves as the root of the recursive
 ...
 *          name based in the files root group) or an object name relative
 ...
 *          the iteration in the callback functions \p op_data parameter.
 *
 ...
 *          a files metadata cache.
 *
 *          This function prevents an objects or caches dirty metadata
 ...
 * \ingroup H5O
 *
 * \brief Enables flushing of dirty metadata entries from a files metadata cache
 *
 ...
 *          of entries from a files metadata cache.
 *
 *          This function allows an object or caches dirty metadata entries to be
 ...
 *       closed.  An objects entries will not necessarily be flushed as a
 ...
 *          entries from a files metadata cache. Metadata cache entries can be controlled
...
#ifndef H5O_MODULE
#define vtkhdf5_H5Oopen_async(...)             vtkhdf5_H5Oopen_async(__FILE__, __func__, __LINE__, __VA_ARGS__)
#define vtkhdf5_H5Oopen_by_idx_async(...)      vtkhdf5_H5Oopen_by_idx_async(__FILE__, __func__, __LINE__, __VA_ARGS__)
#define vtkhdf5_H5Oget_info_by_name_async(...) vtkhdf5_H5Oget_info_by_name_async(__FILE__, __func__, __LINE__, __VA_ARGS__)
#define vtkhdf5_H5Oclose_async(...)            vtkhdf5_H5Oclose_async(__FILE__, __func__, __LINE__, __VA_ARGS__)
#define vtkhdf5_H5Oflush_async(...)            vtkhdf5_H5Oflush_async(__FILE__, __func__, __LINE__, __VA_ARGS__)
#define vtkhdf5_H5Orefresh_async(...)          vtkhdf5_H5Orefresh_async(__FILE__, __func__, __LINE__, __VA_ARGS__)
#define vtkhdf5_H5Ocopy_async(...)             vtkhdf5_H5Ocopy_async(__FILE__, __func__, __LINE__, __VA_ARGS__)

/* Define "wrapper" versions of function calls, to allow compile-time values to
 *      be passed in by language wrapper or library layer on top of HDF5.
 */
#define vtkhdf5_H5Oopen_async_wrap             H5_NO_EXPAND(vtkhdf5_H5Oopen_async)
#define vtkhdf5_H5Oopen_by_idx_async_wrap      H5_NO_EXPAND(vtkhdf5_H5Oopen_by_idx_async)
#define vtkhdf5_H5Oget_info_by_name_async_wrap H5_NO_EXPAND(vtkhdf5_H5Oget_info_by_name_async)
#define vtkhdf5_H5Oclose_async_wrap            H5_NO_EXPAND(vtkhdf5_H5Oclose_async)
#define vtkhdf5_H5Oflush_async_wrap            H5_NO_EXPAND(vtkhdf5_H5Oflush_async)
#define vtkhdf5_H5Orefresh_async_wrap          H5_NO_EXPAND(vtkhdf5_H5Orefresh_async)
#define vtkhdf5_H5Ocopy_async_wrap             H5_NO_EXPAND(vtkhdf5_H5Ocopy_async)
#endif
/// \endcond
 ...
 *
 *          The objects address within the file, \p addr, is the byte offset of the first byte
 ...
 *          the objects address in the \c objno field of the H5G_stat_t \c struct;
 ...
 *          offset within the HDF5 file; HDF5s file drivers will transparently map this to an
 ...
 *
 * \details H5Oget_info_by_name1() specifies an objects location and name, \p loc_id
 ...
 *
 * \details H5Oget_info_by_name2() specifies an objects location and name, \p loc_id and
 ...
 *          functions return value on the application are described
 *          in H5Ovisit1().
 *
